...
public class ChessPiecesFactory {
	 ...
	 */
	public static List<Pieces> newPieces(Couleur pieceCouleur, String gameMode){
				...
				if (pieceCouleur.equals(ChessPiecePos.values()[i].couleur)) {
					for (int j = 0; j < (ChessPiecePos.values()[i].coords).length; j++) {
						...
						pieces.add((Pieces) Introspection.newInstance (className,
								new Object[] {pieceCouleur, pieceCoord, gameMode}));
					}
				}
			}
		}
	...
	public static void main(String[] args) {
		System.out.println(ChessPiecesFactory.newPieces(Couleur.BLANC, "ClassicBehaviourFactory"));
		System.out.println(ChessPiecesFactory.newPieces(Couleur.NOIR, "StormBehaviourFactory"));
	}
}
